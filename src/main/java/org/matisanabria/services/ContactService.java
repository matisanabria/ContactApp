package org.matisanabria.services;

import org.matisanabria.models.Contact;
import org.matisanabria.dao.ContactDAO;
...
public class ContactService {
    ...
    public ContactService() {
        contactos = ContactDAO.loadFromJson();
    ...
    public void addContact(){
        ...
        do {
            ...
            if (nombre.isEmpty() || numero.isEmpty() || email.isEmpty()) {
                ...
                contactos.add(nuevo);
                ContactDAO.saveToJson(contactos);
